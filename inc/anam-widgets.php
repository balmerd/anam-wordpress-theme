<?php
require get_template_directory() . '/inc/classes/anam-event.php';
require get_template_directory() . '/inc/widgets/anam-recent-events-widget.php';
require get_template_directory() . '/inc/widgets/anam-current-events-widget.php';
